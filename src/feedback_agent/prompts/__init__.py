...
# The active baseline diagnosis prompt. Bump this (and the filename) on any edit
# to the prompt body — it is part of the SQLite cache key.
DIAGNOSE_PROMPT_VERSION = "diagnose_v1"
